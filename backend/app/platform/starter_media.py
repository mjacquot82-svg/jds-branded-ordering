...
# V1 binaries are original, procedurally drawn JDS illustrations generated by
# backend/scripts/generate_starter_media.py. They are clearly-labelled placeholders,
# not photographs; licensed photography can later ship as a new asset version.
STARTER_MEDIA_ART_STYLE = "illustrated-placeholder"
STARTER_MEDIA_PROVENANCE = "Original JDS illustration generated in-repo (no third-party or stock imagery)."
...
# Versioned V1 manifest. Archetypes without a shipped binary report available=False and are
# hidden from merchant pickers until reviewed artwork is added (see docs/STARTER_MEDIA_ASSET_MANIFEST.md).

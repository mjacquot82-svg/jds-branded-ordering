...
export default function ProductImage({ src = "", alt, className = "", decorative = false }) {
  ...
  return <img className={className} src={src} alt={decorative ? "" : label} aria-hidden={decorative || undefined} loading="lazy" decoding="async" onError={() => setFailed(true)} />;
}
